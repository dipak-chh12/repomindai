...
class ChatService:
    def __init__(self, vector_service: VectorService):
        ...
        self.system_instruction = (
            ...
            "CRITICAL: Heavily use Markdown formatting! Use headings (##), bold text (**), bullet points, and code blocks (```python) to structure your answer nicely. "
    ...
    def answer_chat(self, question: str, repo_url: str, repo_summary: str = "") -> Dict[str, Any]:
        """
        RAG Chat: Retrieve relevant chunks for the query, construct prompt with repo overview, and get AI answer.
        """
